...
% --------------------------------- %
Kc = (0.45 * Ku) * 1.5; 
Ti = 100000; % Con un valor muy elevado, el PI actúa prácticamente como un P (con error no nulo)
% --------------------------------- %
...
% ----------------------------------------------------------------------- %
% Pese a probar múltiples opciones, este es el mejor resultado que se ha 
% encontrado que cumple la condición de error no nulo (siendo de un 50%,  %
% es decir, mejorando un 3% respecto del P)
% y que menos oscilaciones tiene.
% Aun así, no se logran los resultados esperados, al menos no con error
% no nulo.
% ----------------------------------------------------------------------- %
