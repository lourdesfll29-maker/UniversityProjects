...
%   - Error nulo, esto es, que la respuesta del sistema, se estabilice al %
%     mismo valor que la entrada escalón proporcionado.                   %
%   - La variable a controlar no supere el valor al cual se estabiliza.   %
...
% Kc = (0.45 * Ku) * 0.57; 
% Ti = (Tu / 1.2) * 14.106;
% Donde la estabilización de la respuesta se da en x = 1.2 sin superar el
% valor del escalón.
% ----------------------------------------------------------------------- %